# @zitterorg/deserunt-nesciunt

[![npm](https://img.shields.io/npm/v/@zitterorg/deserunt-nesciunt.svg)](https://npmjs.com/package/@zitterorg/deserunt-nesciunt)

A JavaScript ANSI color/style management. ANSI parsing. ANSI to CSS. Small, clean, no dependencies.

```bash
npm install @zitterorg/deserunt-nesciunt
```
...
```javascript
require ('@zitterorg/deserunt-nesciunt').nice // .nice for unsafe String extensions
...
```javascript
import { green, inverse, bgLightCyan, underline, dim } from '@zitterorg/deserunt-nesciunt'
```
```javascript
const { green, inverse, bgLightCyan, underline, dim } = require ('@zitterorg/deserunt-nesciunt')
```
...
```javascript
const { names } = require ('@zitterorg/deserunt-nesciunt')
...
```javascript
const { strip } = require ('@zitterorg/deserunt-nesciunt')
...
```javascript
const { isEscaped, green } = require ('@zitterorg/deserunt-nesciunt')
...
```javascript
const { parse } = require ('@zitterorg/deserunt-nesciunt')
...
```javascript
const ansi = require ('@zitterorg/deserunt-nesciunt')
...
```javascript
const { bgGreen, red, parse } = require ('@zitterorg/deserunt-nesciunt')
...
## Projects That Use `@zitterorg/deserunt-nesciunt`
